...
programındaki classları yarın öbür gün başka projelerde kullanmak isteyebilirsin. bunun mümkün olması için, sınıfları birbirine bağımlı hale getirmeden kullanman gerekir. bunu nasıl yaparız? aşağıda birbirine bağımlı sınıflar gösterilmiştir;
...
#+RESULTS:
[[file:/tmp/babel-AKVKVd/plantuml-K0IIS1.png]]
