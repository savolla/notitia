...
+ componentler içinde benzer bir işi yapan sınıflar barındırırlar. bu sınıflar tabiki package'larla ayrılmış da olabilir
...
+ componentler, bir binanın tuğlaları gibi düşünülebilir
