...
*** presentation layer
how user sees the results from business layer. this includes some User Interface Design thingies. html, javascript, css play here together
...
+ [[https://www.youtube.com/watch?v=ZKa5LwFgAOA][Gates of Morheim - Omagatoki]]
  similar to Kurotokage but deeper and darker. Japanese Synth is the meta now btw
