...
***** effective coding with doom emacs
Th is how I use doom emacs for daily coding. Doom and it's packages are doing great job for programming. The knowledge of doing programming is spread to the internet so you have to find every bit of information and collect it. Here I made a complete list for you guys. This is a *step by step* guide so I'm not gonna load your brain with bullshit. By the way when I say things like =C-c C-p= it means =CTRL + c + p=
****** before we start
...
****** cloning your project with doom
...
1. =SPC SPC= brings menu with all files in your project
2. type any keyword you want
you don't have to type entire name of your file. menu items will be reduced once you type some characters.
****** find any keyword in your entire project
1. press =SPC /=
...
5. =C-i= to go *forward*
****** recent files
if you work on other things other than your project, for example editin some config files while coding etc, then you probably write the *path* every single time to navigate to that config file. doom solves it with
