...
=C= Cummulative Distribution Function (CDF):

** My Note Taking Technique
*** tags bullet
- =F= fact
- =S= subject
- =C= concept / term
- =T= step by step tutorial
- =E= example
- =I= personal idea / opinion
- =N= independent note
- =Q= quiz
- =L= list / table / chart
- =D= date
...
- suç ve ceza
*** watch movie
- [ ] [[https://www.youtube.com/watch?v=onM1l2F-2o4][Zeitgeist III]]
