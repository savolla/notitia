...
Th is how I use doom emacs for daily coding. Doom and it's packages are doing great job for programming. The knowledge of doing programming is spread to the internet so you have to find every bit of information and collect it. Here I made a complete list for you guys. This is a *step by step* guide so I'm not gonna load your brain with bullshit
...
1. add your project
****** find function, string or variable in project
+ press =SPC
**** how to
