...
6. run the project. let visual studio download thatever it needs to download. the first run will take some time btw
******* folders and MVC
...
*** how to
**** search github
1. go to [[www.github.com/search][github search]]
