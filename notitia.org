...
+ package diyagramları: UML elemanlarını gruplamak için kullanılır
+ bir private ve bir public sınıfın bir package içine alınması:
...
+ package diyagramları aynı zamanda *use case*'leri de gruplayabilir
