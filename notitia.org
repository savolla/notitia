...
+ recruiters look for the following;
  ...
  - coding skills
    ...
    b. how *good* was your *style*
    c. did you *hangle errors*
  - computer science knowledge. do you have strong foundation or not
  - did you make *challanging* / *interesting* projects or not
...
+ the reason behind *whiteboard coding* is that recruiters want you to focus on _actual problem solving_ instead of *restricted* computer environment when compilers spit errors all over the place. the code you write does not need to be perfect and it's okay if it contain some syntactical errors. just show to the interviewer how you approach to the problem
...
+ interviewers always be compare your performance to others that came before and after you. even if you think that you performed well, a japanese hacker who came before you can change all the game. it's all about luck m8
