...
int main(void) {
    ...
    // set bits
    ,*clock |= (1 < 3); // set 3rd bit of RCC_AHB1ENR to enable GPIOD
    ,*gpiod_mode_register |= (1 < 23); // set 23th bit to set output of pin 12
    ,*gpiod_output_register |= (1 < 12) // set 12th GPIO pin to 3.3V
