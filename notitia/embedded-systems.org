...
pacaur -S microchip-mplabxc8-bin
#+end_src
...
#+begin_src c
#define ADDRESS_OF_TEMPERATURE_SENSOR 0xDEADBEAF

char *temeratureSensor = (char *)ADDRESS_OF_TEMPERATURE_SENSOR
#+end_src
...
*** xc8
compiler for 8-bit PIC microcontrollers. supports PIC10/12/16/18 devices
